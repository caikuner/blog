...
module.exports = {
  ...
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: 'https://huangpanpan.oss-cn-hangzhou.aliyuncs.com/image/blog_avatar.jpg',
    name: 'Panda',
    slogan: '',
  },
  social: {
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:2210866448@qq.com',
      },
      {
        iconClass: 'icon-QQ',
        title: '加QQ',
        link: 'tencent://message/?uin=2210866448&Site=&Menu=yesUrl',
      },
      // {
